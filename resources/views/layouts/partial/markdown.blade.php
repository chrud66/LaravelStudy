        ...
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                ...
                <tr>
                    ...
                    <td>{!! markdown('Paragraphs are separated by a blank line.') !!}</td>
                </tr>
                <tr>
                    <td>Let 2 spaces at the end of a line to do a&nbsp;&nbsp;<br/> line break</td>
                    <td>{!! markdown('Let 2 spaces at the end of a line to do a line break') !!}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{!! markdown('- apples - oranges - pears') !!}</td>
                </tr>
                <tr>
                    <td>1. apples<br/>2. oranges<br/>3. pears</td>
                    <td>{!! markdown('1. apples 2. oranges 3. pears') !!}</td>
                </tr>
                <tr>
                    <td>```<br/> public function clear(key) {<br/> &nbsp;&nbsp;&nbsp;&nbsp;return this.cache.flush(key);<br/> }
                        <br/> ```
                        <br/>
                        <small class="text-muted">3 tilde(~~~) is also possible.</small>
                    </td>
                    <td>{!! markdown('``` public function clear(key) { return this.cache.flush(key); } ```') !!}</td>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>{!! markdown('Markdown | Less | Pretty --- | --- | --: *Still* | `renders` | **nicely** 1 | 2 | 3') !!}</td>
                </tr>
                <tr>
                    <td>>Blockquotes are very handy in email to emulate reply text.<br/> > This line is part of the same quote.
                        <br/> <br/> Quote break.<br/> <br/> > This is a very long line that will still be quoted properly when it wraps.
                        Oh boy let's keep writing to make sure this is long enough to actually wrap for everyone. Oh, you can *put* **Markdown**
                        into a blockquote.
                    </td>
                    <td>{!! markdown('>Blockquotes are very handy in email to emulate reply text. >This line is part of the same quote. Quote
                        break. > This is a very long line that will still be quoted properly when it wraps. Oh boy let\'s keep writing to
                        make sure this is long enough to actually wrap for everyone. Oh, you can *put* **Markdown** into a blockquote.')
                        !!}</td>
                </tr>
                <tr>
                    <td>---</td>
                ...
                <tr>
                    ...
                    <td>{!! markdown('[![IMAGE ALT TEXT HERE](http://img.youtube.com/vi/dhI9bsQwFRw/1.jpg)](http://www.youtube.com/watch?v=dhI9bsQwFRw)')
                        !!}</td>
                </tr>
                <tr>
                    <td>That's some text with a footnote.[^1]<br/>[^1]: And that's the footnote.</td>
                    <td>{!! markdown('That\'s some text with a footnote.[^1] [^1]: And that\'s the footnote.') !!}</td>
                </tr>
                <tr>
